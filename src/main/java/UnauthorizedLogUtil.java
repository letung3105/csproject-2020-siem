...
public class UnauthorizedLogUtil {
    ...
    public static Configuration getConfiguration() {
        ...
        configuration.getCommon().addEventType(UnauthorizedLogin.class);
        configuration.getCommon().addEventType(UnauthorizedAlert.class);

...
public class FileTooLargeSameUserIDAlertListener implements UpdateListener {
    private static final Logger log = LoggerFactory.getLogger(FailedLoginSameUserIDAlertListener.class);

    private long highPriorityThreshold;

    public FileTooLargeSameUserIDAlertListener(long highPriorityThreshold) {
